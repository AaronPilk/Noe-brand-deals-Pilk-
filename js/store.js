...
const NVStore = (() => {
  ...
  const DEFAULT_VOICE_PROFILE = {
    ...
    pricing: "Anchor above the floor: $1,000/post internal minimum, three-post minimum, $3,000 minimum organic package. Rights, licensing, whitelisting, exclusivity always priced separately. Ask for budget before quoting when none is given. AI likeness/voice/training rights: separate legal + commercial negotiation, 3-10x baseline, usually declined."
  };
